...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('PAPERLESS_EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = os.environ.get('PAPERLESS_EMAIL_HOST_PASSWORD')
DEFAULT_FROM_EMAIL = os.environ.get('PAPERLESS_DEFAULT_FROM_EMAIL')
#FIN- DARALY ******
...
def _parse_db_settings() -> dict:
    databases = {
        "default": {
            ...
            "NAME": os.path.join(DATA_DIR, "db.postgresql"),
            "OPTIONS": {},
        },
    }
